...
const translations = Object.freeze({
  hi: Object.freeze({
    ...
    "Account": "खाता",
    "AccessFlow had trouble restoring front desk operations. Refreshing workspace...": "AccessFlow फ्रंट डेस्क संचालन बहाल नहीं कर सका। कार्यक्षेत्र रीफ्रेश हो रहा है...",
    ...
    "Device readiness will appear after the API responds.": "API प्रतिक्रिया के बाद डिवाइस तैयारी दिखाई देगी।",
    ...
    "Generate audit-safe CSV or print-ready PDF exports from backend reporting endpoints.": "बैकएंड रिपोर्टिंग एंडपॉइंट से ऑडिट-सुरक्षित CSV या प्रिंट-तैयार PDF एक्सपोर्ट बनाएं।",
    ...
    "Scan the visitor badge, verify its live approval state, then record check-in or check-out from the result panel.": "आगंतुक बैज स्कैन करें, उसकी लाइव स्वीकृति स्थिति सत्यापित करें, फिर परिणाम पैनल से चेक-इन या चेक-आउट दर्ज करें।",
