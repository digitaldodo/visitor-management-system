    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/mobile/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "EMPLOYEE", "SECURITY_GUARD", "RECEPTION", "OPERATOR", "MANAGER", "VISITOR")
                        .requestMatchers("/api/v1/notifications/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "EMPLOYEE", "SECURITY_GUARD", "RECEPTION", "OPERATOR", "MANAGER", "VISITOR")
                        .requestMatchers("/api/v1/admin/**").hasAnyRole("SUPER_ADMIN", "ADMIN")
                        .requestMatchers("/api/v1/employee/**").hasAnyRole("EMPLOYEE", "RECEPTION", "OPERATOR", "MANAGER")
