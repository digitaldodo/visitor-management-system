...
| Role | Email | Password |
| --- | --- | --- |
| `ADMIN` | `admin@visitor.local` | `Admin@12345` |
| `EMPLOYEE` | `employee@visitor.local` | `Employee@12345` |
| `SECURITY_GUARD` | `security@visitor.local` | `Security@12345` |
...
| `POST` | `/auth/forgot-password` | Public | Create password reset token structure |
