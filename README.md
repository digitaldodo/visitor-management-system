...
Open `frontend/index.html` with a local static server. For local API testing, override `window.API_BASE_URL` in `frontend/assets/js/env.js` or serve a local generated copy; the checked-in fallback points to the deployed Spring Boot API.
