...
const translations = {
  en: {
    ...
    'runtime.offlineMode': 'Continuity mode',
    'runtime.syncing': 'Updating workspace...',
    'runtime.degradedSync': 'Continuity mode',
    'runtime.deviceReview': 'Device review required',
    'runtime.queuedActions': 'Actions awaiting review',
    'runtime.notificationsLimited': 'Notifications limited',
    'runtime.offlineBody': 'Known visitor and workforce records remain available. {count} action(s) will finish automatically.',
    'runtime.offlineBodyNoQueue': 'Known visitor and workforce records remain available. {lastSync}',
    'runtime.syncingBody': 'AccessFlow is safely completing saved checkpoint actions and updating operational records.',
    ...
    'runtime.queuedBody': '{count} action(s) awaiting review, including {scanCount} scan(s). Access is marked provisional until AccessFlow confirms.',
    ...
    'runtime.noSyncTime': 'No recent update time is available yet.',
    'runtime.lastSync': 'Last updated {time}.',
    'feed.tab': 'Activity',
    ...
    'feed.summaryQueued': 'Actions in review',
    'feed.summaryOffline': 'Continuity',
    ...
    'feed.offlineBannerTitle': 'Continuity-aware feed',
    'feed.offlineBannerBody': 'This stream includes saved local events. Treat continuity items as provisional until AccessFlow confirms.',
    'feed.pendingSync': 'Pending review',
    'feed.generatedOffline': 'Created during continuity mode',
    ...
    'feed.sourceOffline': 'Saved action',
    ...
    'feed.eventOfflineQueued': '{title} awaiting review',
    'feed.eventRuntimeOffline': 'Workspace continuity active',
    'feed.eventRuntimeDegraded': 'Workspace is restoring',
    'feed.eventRuntimeRecovered': 'Workspace updated',
  ...
  hi: {
    ...
    'runtime.offlineMode': 'निरंतरता मोड',
    'runtime.syncing': 'सुरक्षित रूप से अपडेट हो रहा है...',
    'runtime.degradedSync': 'निरंतरता मोड',
    'runtime.deviceReview': 'डिवाइस समीक्षा आवश्यक',
    'runtime.queuedActions': 'समीक्षा के लिए कार्रवाई लंबित',
    'runtime.notificationsLimited': 'सूचनाएं सीमित',
    'runtime.offlineBody': 'ज्ञात आगंतुक और कार्यबल रिकॉर्ड उपलब्ध रहेंगे। {count} कार्रवाई अपने-आप पूरी होगी।',
    'runtime.offlineBodyNoQueue': 'ज्ञात आगंतुक और कार्यबल रिकॉर्ड उपलब्ध रहेंगे। {lastSync}',
    'runtime.syncingBody': 'AccessFlow सहेजी गई चेकपॉइंट कार्रवाइयों को सुरक्षित रूप से पूरा कर रहा है।',
    'runtime.suspiciousBody': 'यह डिवाइस सत्र नीति द्वारा चिन्हित है। सुरक्षित पुनरारंभ तक संचालन सीमित रहेगा।',
    'runtime.queuedBody': '{count} कार्रवाई समीक्षा में हैं, जिनमें {scanCount} स्कैन शामिल हैं। AccessFlow पुष्टि तक एक्सेस अस्थायी माना जाएगा।',
    'runtime.pushDeniedBody': 'इस डिवाइस पर पुश सूचनाएं बंद हैं। ऐप खुले रहने पर इन-ऐप अलर्ट मिलते रहेंगे।',
    'runtime.noSyncTime': 'अभी हाल का अपडेट समय उपलब्ध नहीं है।',
    'runtime.lastSync': 'अंतिम अपडेट {time}।',
    'feed.tab': 'गतिविधि',
    ...
    'feed.summaryQueued': 'समीक्षा में कार्रवाई',
    'feed.summaryOffline': 'निरंतरता',
    ...
    'feed.offlineBannerTitle': 'निरंतरता-सक्षम फीड',
    'feed.offlineBannerBody': 'इस स्ट्रीम में सहेजी गई स्थानीय घटनाएं शामिल हैं। AccessFlow पुष्टि तक इन्हें अस्थायी मानें।',
    'feed.pendingSync': 'समीक्षा लंबित',
    'feed.generatedOffline': 'निरंतरता मोड में बनाई गई',
    ...
    'feed.sourceOffline': 'सहेजी गई कार्रवाई',
    ...
    'feed.eventNotification': '{title}',
    'feed.eventOfflineQueued': '{title} समीक्षा में है',
    'feed.eventRuntimeOffline': 'कार्यस्थल निरंतरता सक्रिय है',
    'feed.eventRuntimeDegraded': 'कार्यस्थल बहाल हो रहा है',
    'feed.eventRuntimeRecovered': 'कार्यस्थल अपडेट हुआ',
...
const staticTextTranslations = {
  hi: {
    ...
    'Your previous sessions were cleared. Sign in again with the new password.': 'आपके पिछले सत्र साफ कर दिए गए। नए पासवर्ड से फिर साइन इन करें।',
    ...
    'Sensitive account updates are verified by AccessFlow and active sessions are cleared after password changes.': 'संवेदनशील खाता बदलाव AccessFlow से सत्यापित होते हैं और पासवर्ड बदलने के बाद सक्रिय सत्र साफ होते हैं।',
    ...
    'For security, AccessFlow will sign you out because active sessions were cleared.': 'सुरक्षा के लिए AccessFlow आपको साइन आउट करेगा क्योंकि सक्रिय सत्र साफ हो गए।',
    ...
    'Active': 'सक्रिय',
    'Protection': 'सुरक्षा',
    'Encrypted access': 'एन्क्रिप्टेड एक्सेस',
    'Updates': 'अपडेट',
    'Automatic': 'स्वचालित',
    'Notifications': 'सूचनाएं',
    'Enabled': 'सक्षम',
    'Secure account': 'खाता सुरक्षित करें',
