...
const translations = {
  en: {
    ...
    'feed.subtitle': 'A real-time operational stream for visitor, workforce, incident, approval, sync, and alert activity.',
    'feed.summaryLive': 'Live events',
    'feed.summaryAlerts': 'Priority alerts',
    'feed.summaryQueued': 'Pending sync',
    'feed.summaryOffline': 'Offline mode',
    'feed.summarySynced': 'Runtime synced',
    'feed.filtersAll': 'All',
    ...
    'feed.streamTitle': 'Operational stream',
    'feed.streamSubtitle': 'Events are grouped by repeated activity and refreshed automatically through runtime sync.',
    'feed.emptyTitle': 'No operational activity yet',
    'feed.emptyBody': 'Visitor, workforce, approval, incident, notification, and offline sync events will appear here.',
    ...
    'feed.sourceRuntime': 'Runtime',
    'feed.sourceOffline': 'Offline queue',
  ...
  hi: {
    ...
    'feed.tab': 'लाइव',
    'feed.title': 'लाइव गतिविधि',
    'feed.subtitle': 'आगंतुक, कार्यबल, घटना, अनुमति, सिंक और अलर्ट के लिए रियल-टाइम ऑपरेशनल स्ट्रीम।',
    'feed.summaryLive': 'लाइव घटनाएं',
    'feed.summaryAlerts': 'प्राथमिक अलर्ट',
    'feed.summaryQueued': 'सिंक लंबित',
    'feed.summaryOffline': 'ऑफलाइन मोड',
    'feed.summarySynced': 'रनटाइम सिंक',
    'feed.filtersAll': 'सभी',
    ...
    'feed.streamTitle': 'ऑपरेशनल स्ट्रीम',
    'feed.streamSubtitle': 'दोहराई गई गतिविधियां समूहित होती हैं और रनटाइम सिंक से अपने-आप ताजा रहती हैं।',
    'feed.emptyTitle': 'अभी कोई ऑपरेशनल गतिविधि नहीं',
    'feed.emptyBody': 'आगंतुक, कार्यबल, अनुमति, घटना, सूचना और ऑफलाइन सिंक की घटनाएं यहां दिखेंगी।',
    ...
    'feed.sourceRuntime': 'रनटाइम',
    'feed.sourceOffline': 'ऑफलाइन कतार',
